...
- pobierz a następnie wyświetl wszystkie parametry w jednej lini. np.:
```
1 John 4 Kowalski 
```
...
- pobierz wszystkie parametry a następnie wyświetli je w odwrotnej kolejności.
